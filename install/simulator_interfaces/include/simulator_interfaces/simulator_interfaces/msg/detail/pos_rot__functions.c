...
simulator_interfaces__msg__PosRot__create()
{
  ...
  simulator_interfaces__msg__PosRot * msg = (simulator_interfaces__msg__PosRot *)allocator.allocate(sizeof(simulator_interfaces__msg__PosRot), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(simulator_interfaces__msg__PosRot));
  bool success = simulator_interfaces__msg__PosRot__init(msg);
  if (!success) {
...
simulator_interfaces__msg__PosRot__destroy(simulator_interfaces__msg__PosRot * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    simulator_interfaces__msg__PosRot__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
simulator_interfaces__msg__PosRot__Sequence__init(simulator_interfaces__msg__PosRot__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  simulator_interfaces__msg__PosRot * data = NULL;

  if (size) {
    data = (simulator_interfaces__msg__PosRot *)allocator.zero_allocate(size, sizeof(simulator_interfaces__msg__PosRot), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = simulator_interfaces__msg__PosRot__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        simulator_interfaces__msg__PosRot__fini(&data[i - 1]);
      }
...
simulator_interfaces__msg__PosRot__Sequence__fini(simulator_interfaces__msg__PosRot__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      simulator_interfaces__msg__PosRot__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  simulator_interfaces__msg__PosRot__Sequence * array = (simulator_interfaces__msg__PosRot__Sequence *)allocator.allocate(sizeof(simulator_interfaces__msg__PosRot__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = simulator_interfaces__msg__PosRot__Sequence__init(array, size);
  if (!success) {
...
simulator_interfaces__msg__PosRot__Sequence__destroy(simulator_interfaces__msg__PosRot__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    simulator_interfaces__msg__PosRot__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
simulator_interfaces__msg__PosRot__Sequence__are_equal(const simulator_interfaces__msg__PosRot__Sequence * lhs, const simulator_interfaces__msg__PosRot__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!simulator_interfaces__msg__PosRot__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  simulator_interfaces__msg__PosRot__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(simulator_interfaces__msg__PosRot);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    simulator_interfaces__msg__PosRot * data =
      (simulator_interfaces__msg__PosRot *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!simulator_interfaces__msg__PosRot__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          simulator_interfaces__msg__PosRot__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!simulator_interfaces__msg__PosRot__copy(
