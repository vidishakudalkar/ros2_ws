...
#include "simulator_interfaces/msg/detail/pos_rot__rosidl_typesupport_fastrtps_c.h"
...
using _PosRot__ros_msg_type = simulator_interfaces__msg__PosRot;
...
size_t get_serialized_size_simulator_interfaces__msg__PosRot(
  const void * untyped_ros_message,
...
static uint32_t _PosRot__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_simulator_interfaces__msg__PosRot(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_simulator_interfaces
size_t max_serialized_size_simulator_interfaces__msg__PosRot(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _PosRot__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_simulator_interfaces__msg__PosRot(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, simulator_interfaces, msg, PosRot)() {
